...
corrections <- corrections %>% 
  ...
  select(`L-EV Charge Point ID`, `Site Name`, `Feat Loc`, `Cent East`, 
         `Cent North`, `Bay Position in Lot`, `EF Comments`) %>%
...
corrections$labs <- sapply(seq(nrow(corrections)), function(i) {
  paste0( '<p><strong>', corrections[i, "LocationName"], '</strong></p><hr></hr><p><strong>Feature: </strong>',
          ...
          corrections[i, "EF Comments"], '</p><p><strong>Bay Location: </strong>',
